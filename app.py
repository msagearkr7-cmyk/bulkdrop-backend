...
# This contains your exact BulkDrop UI, modified to default to the Research Tool
...
<div class="quick-row">
  <!-- Changed default active class to Research Tool -->
...
<script>
  ...
  // Set default mode to keyword research
  let mode = 'keyword'; 
